        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YouTubeChannelId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackedSince = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Rating_OneTarget", "([ChannelId] IS NOT NULL AND [VideoId] IS NULL) OR ([ChannelId] IS NULL AND [VideoId] IS NOT NULL)");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Suggestions_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    VideoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AddedToLibraryAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SummaryGenerationRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SummaryGenerationRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SummaryGenerationRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SummaryGenerationRequests_Summaries_SummaryId",
                        column: x => x.SummaryId,
                        principalTable: "Summaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SummaryGenerationRequests_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_UserId_ChannelId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_UserId_VideoId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suggestions_IsApproved",
                table: "Suggestions",
                column: "IsApproved");

            migrationBuilder.CreateIndex(
                name: "IX_Suggestions_IsDenied",
                table: "Suggestions",
                column: "IsDenied");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Summaries_GenerationCount",
                table: "Summaries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_RequestedAt",
                table: "SummaryGenerationRequests",
                column: "RequestedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_SummaryId",
                table: "SummaryGenerationRequests",
                column: "SummaryId");

            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_UserId",
                table: "SummaryGenerationRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_UserId_RequestedAt",
                table: "SummaryGenerationRequests",
                columns: new[] { "UserId", "RequestedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_VideoId",
                table: "SummaryGenerationRequests",
                column: "VideoId");

            migrationBuilder.CreateIndex(
                name: "IX_SummaryGenerationRequests_WasSuccessful",
                table: "SummaryGenerationRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChannels_TrackedSince",
                table: "UserChannels",
                column: "TrackedSince");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVideos_AddedToLibraryAt",
                table: "UserVideos",
                column: "AddedToLibraryAt");

            migrationBuilder.CreateIndex(
                name: "IX_UserVideos_Status",
                table: "UserVideos",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVideos_UserId_VideoId",
                table: "UserVideos",
                columns: new[] { "UserId", "VideoId" },
                unique: true);
