...
namespace TargetBrowse.Migrations
{
    ...
    [Migration("20260215051739_MoveScriptPromptsToDatabase")]
    partial class MoveScriptPromptsToDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TargetBrowse.Data.Entities.ScriptContentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AnalysisAICallId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AnalysisJsonResult")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("EstimatedLengthMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("OutlineAICallId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("OutlineJsonStructure")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ScriptAICallId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("TargetLengthMinutes")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnalysisAICallId");

                    b.HasIndex("GeneratedAt");

                    b.HasIndex("OutlineAICallId");

                    b.HasIndex("ProjectId")
                        .IsUnique();

                    b.HasIndex("ScriptAICallId");

                    b.HasIndex("ScriptStatus");

                    b.ToTable("ScriptContents", (string)null);
                });
            ...
            modelBuilder.Entity("TargetBrowse.Data.Entities.TopicVideoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TopicId", "VideoId")
                        .IsUnique()
                        .HasDatabaseName("IX_TopicVideos_TopicId_VideoId");

                    b.ToTable("TopicVideos", (string)null);
                });
            ...
            modelBuilder.Entity("TargetBrowse.Data.Entities.UserScriptProfileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AudienceRelationship")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("InformationDensity")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("RhetoricalStyle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("StructureStyle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("UserScriptProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("TargetBrowse.Data.Entities.ScriptContentEntity", b =>
                {
                    b.HasOne("TargetBrowse.Data.Entities.AICallEntity", "AnalysisAICall")
                        .WithMany("ScriptAnalysisCalls")
                        .HasForeignKey("AnalysisAICallId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("TargetBrowse.Data.Entities.AICallEntity", "OutlineAICall")
                        .WithMany("ScriptOutlineCalls")
                        .HasForeignKey("OutlineAICallId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("TargetBrowse.Data.Entities.ProjectEntity", "Project")
                        .WithOne("ScriptContent")
                        .HasForeignKey("TargetBrowse.Data.Entities.ScriptContentEntity", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TargetBrowse.Data.Entities.AICallEntity", "ScriptAICall")
                        .WithMany("ScriptGenerationCalls")
                        .HasForeignKey("ScriptAICallId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("AnalysisAICall");

                    b.Navigation("OutlineAICall");

                    b.Navigation("Project");

                    b.Navigation("ScriptAICall");
                });
            ...
            modelBuilder.Entity("TargetBrowse.Data.Entities.AICallEntity", b =>
                {
                    ...
                    b.Navigation("ScriptAnalysisCalls");

                    b.Navigation("ScriptGenerationCalls");

                    b.Navigation("ScriptOutlineCalls");
